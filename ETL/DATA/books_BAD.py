#%%writefile loading_data.py
# create a table
# insert the data into the new table
# paste all code into books.py
# convert, extract, transform, and load into functdions
# run our books.py file with: 
