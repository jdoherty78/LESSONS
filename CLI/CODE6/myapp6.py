...
cli = click.CommandCollection(sources=[cli1, cli2], chain = True) #not recommended to have on one line
...
#python .\myapp6.py create init info
#create app!
#init app!
#Author is Cal Ripken Jr.

#python .\myapp6.py init info create
#init app!
#Author is Cal Ripken Jr.
#create app!
#
